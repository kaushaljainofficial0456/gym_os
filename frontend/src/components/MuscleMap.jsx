...
const MAP_THEMES = {
  dark: {
    ...
    activeFill: 'rgba(196,248,42,.38)',
    activeStroke: 'rgba(196,248,42,.55)',
    hoverFill: 'rgba(255,255,255,.16)',
    idleFill: 'rgba(255,255,255,.07)',
    idleStroke: 'rgba(255,255,255,.05)',
    selectedStroke: 'rgba(196,248,42,.9)',
    gradStart: '#8CB800',
    gradEnd: '#C4F82A',
    filterActive: 'drop-shadow(0 0 6px rgba(196,248,42,.45))',
    gradientId: 'burnGrad',
  },
  light: {
    silhouetteFill: 'rgba(0,0,0,.06)',
    activeFill: 'rgba(90,140,0,.35)',
    activeStroke: 'rgba(90,140,0,.60)',
    hoverFill: 'rgba(0,0,0,.10)',
    idleFill: 'rgba(0,0,0,.05)',
    idleStroke: 'rgba(0,0,0,.08)',
    selectedStroke: 'rgba(90,140,0,.90)',
    gradStart: brand.light.accent,
    gradEnd: '#3A6E00',
    filterActive: 'drop-shadow(0 0 8px rgba(90,140,0,.35))',
