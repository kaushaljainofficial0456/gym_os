...
const THEMES = {
  dark: {
    ...
    muscleFill: 'rgba(18,184,176,0.45)',
    muscleGlow: '#12B8B0',
    muscleGlowOpacity: 0.35,
    accentStart: '#087F7B',
    accentEnd: '#12B8B0',
    barColor: '#EDEFF7',
    barShadow: 'rgba(18,184,176,0.4)',
    groundStroke: 'rgba(255,255,255,0.08)',
    glowColor: 'rgba(18,184,176,0.08)',
    textPrimary: '#EDEFF7',
    ...
    restGlow: 'rgba(18,184,176,0.12)',
    prGlow: 'rgba(255,196,61,0.25)',
    prColor: '#FFC43D',
    bgGradient: 'radial-gradient(140% 100% at 50% 110%, rgba(18,184,176,0.06), transparent 55%)',
  },
  light: {
    bodyStroke: 'rgba(61,48,38,0.3)',
    bodyFill: 'rgba(61,48,38,0.04)',
    muscleFill: 'rgba(140,106,77,0.4)',
    muscleGlow: '#8C6A4D',
    muscleGlowOpacity: 0.25,
    accentStart: '#8C6A4D',
    accentEnd: '#A07855',
    barColor: '#3D3026',
    barShadow: 'rgba(140,106,77,0.35)',
    groundStroke: 'rgba(61,48,38,0.1)',
    glowColor: 'rgba(140,106,77,0.06)',
    textPrimary: '#3D3026',
    textSecondary: 'rgba(61,48,38,0.5)',
    chipBg: 'rgba(61,48,38,0.05)',
    chipBorder: 'rgba(61,48,38,0.1)',
    controlBg: 'rgba(61,48,38,0.06)',
    controlBorder: 'rgba(61,48,38,0.1)',
    restGlow: 'rgba(140,106,77,0.08)',
    prGlow: 'rgba(180,120,40,0.15)',
    prColor: '#B47828',
    bgGradient: 'radial-gradient(140% 100% at 50% 110%, rgba(140,106,77,0.06), transparent 55%)',
  },
};
