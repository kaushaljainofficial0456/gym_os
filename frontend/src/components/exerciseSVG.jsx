...
const THEMES = {
  dark: {
    ...
    containerGradient: 'radial-gradient(120% 80% at 50% 110%, rgba(196,248,42,.08), transparent 55%)',
    chipBg: '!bg-bg/70',
  ...
  light: {
    ...
    containerGradient: 'radial-gradient(120% 80% at 50% 110%, rgba(90,140,0,.08), transparent 55%)',
    chipBg: '!bg-panel/90',
