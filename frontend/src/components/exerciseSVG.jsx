...
const THEMES = {
  dark: {
    figStroke: brand.dark.ink,
    accentStart: brand.dark.accentDeep,
    accentEnd: brand.dark.accent,
    glowColor: brand.dark.accentDeep,
    glowOpacity: '.20',
    groundStroke: 'rgba(255,255,255,.12)',
    plateFill: brand.dark.panel,
    plateStroke: 'rgba(255,255,255,.16)',
    benchFill: brand.dark.panel,
    benchStroke: 'rgba(255,255,255,.12)',
    containerGradient: 'radial-gradient(120% 80% at 50% 110%, rgb(var(--accent-rgb) / .08), transparent 55%)',
    chipBg: '!bg-bg/70',
  ...
  light: {
    ...
    accentEnd: brand.light.accentDeep,
    glowColor: brand.light.accent,
    glowOpacity: '.16',
    groundStroke: 'rgba(0,0,0,.08)',
    plateFill: brand.light.accent,
    plateStroke: 'rgba(0,0,0,.15)',
    benchFill: '#C4C4C4',
    benchStroke: 'rgba(0,0,0,.12)',
    containerGradient: 'radial-gradient(120% 80% at 50% 110%, rgb(var(--accent-rgb) / .08), transparent 55%)',
    chipBg: '!bg-panel/90',
